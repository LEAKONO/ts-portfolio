...
export default function App() {
  ...
  useEffect(() => {
    ...
    metaDescription.content =
      "Professional portfolio of Emmanuel Leakono, Full-Stack Developer";
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle at 75% 30%, rgba(139, 92, 246, 0.15) 0%, transparent 50%)",
            y: y1,
          }}
        />
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle at 25% 70%, rgba(236, 72, 153, 0.15) 0%, transparent 50%)",
            y: y2,
          }}
        />
